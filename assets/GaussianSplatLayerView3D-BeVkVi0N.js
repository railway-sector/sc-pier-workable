...
vec3 additionalLight = mainLightIntensity * additionalAmbientScale * ambientBoostFactor * lightingGlobalFactor;`,l=x`
  ...
  `),s}function Jt(n){const{clippingEnabled:e,hasSlicePlane:t,receiveShadows:i}=n;return i||t||e}const ja=Dt(),Wa=Object.freeze(Object.defineProperty({__proto__:null,GaussianSplatPassParameters:Ft,build:_i},Symbol.toStringTag,{value:"Module"}));let Gt=class extends Tt{};function xi(n){const e=new tt;e.include(ni);const{hasEmission:t}=n,i=e.fragment;return t&&i.include(Ji,n),i.uniforms.add(new Le("colorTexture",a=>a.color),new Le("splatOutputColor",a=>a.splatColor)),t&&i.uniforms.add(new Le("emissionTexture",a=>a.emission)),e.outputs.add("fragColor","vec4",0),t&&e.outputs.add("fragEmission","vec4",1),e.fragment.main.add(x`
      ...
      ${ae(t,x`
        ...
        `)}
    `),e}const Na=Object.freeze(Object.defineProperty({__proto__:null,GaussianSplatCompositionPassParameters:Gt,build:xi},Symbol.toStringTag,{value:"Module"}));let Xe=class extends it{constructor(){super(...arguments),this.shader=new at(Na,()=>st(()=>Promise.resolve().then(()=>Ka),void 0))}initializePipeline(){return nt({colorWrite:ri,depthTest:null,depthWrite:Rt})}};Xe=C([Ce("esri.views.3d.webgl-engine.shaders.GaussianSplatCompositionTechnique")],Xe);class yi extends Ki{constructor(){super(...arguments),this.hasEmission=!1}}C([he()],yi.prototype,"hasEmission",void 0);class It extends Tt{}function wi(){const n=new tt;n.include(ni);const e=n.fragment;return e.uniforms.add(new Le("splatOutputDepth",t=>t.splatDepth)),e.include(vi),e.main.add(x`vec4 splatDepth = texture(splatOutputDepth, uv);
