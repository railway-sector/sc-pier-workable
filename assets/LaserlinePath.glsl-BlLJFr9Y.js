import{jI as be,l$ as we,p5 as De,DM as f,oY as w,p2 as Ve,oO as F,Ho as r,ru as j,Fl as ee,AU as xe,oV as E,kT as te,i1 as A,iM as B,p6 as ye,Bh as ie,DS as ne,oT as S,g0 as _,zQ as v,Mn as se,z3 as ae,xY as o,Iv as re,gN as Le,F as Ee,e$ as Se,nK as le,y8 as oe,JG as Ce,Hu as Me,tq as Ae,Hr as $e,oZ as Re,zm as H,nG as Te,mO as ce,GP as he,it as de,l0 as Oe,CG as G,JN as z,iq as c,kJ as q,Gn as pe,fl as ue,nJ as Ie,I9 as I,i7 as Ue,DP as ze,CY as je,jJ as qe,tO as V,IC as Ne,gt as k,FM as We,C$ as Fe,C6 as $,AW as Be,aW as J,xa as He,JV as Ge,eJ as ke,BA as Je,kg as Ye,tb as Qe,iy as C,kv as Xe,G3 as Y}from"./index-CanLNgUN.js";import{t as Ze}from"./VisualElement-C0gvv2zT.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new F("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>_(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>_(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new E("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(D,l),te(D,D,u),A(d,D),d[3]=B(D),d)),new ye("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,ie(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/B(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
...
vec4 color = vec4(0.0);`),t.heightManifoldEnabled){n.uniforms.add(new S("angleCutoff",s=>M(s)),new E("heightPlane",(s,a)=>me(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,u),a.camera.viewMatrix)));const i=t.spherical?r`normalize(globalOrigin - pos)`:r`heightPlane.xyz`;n.main.add(r`
      ...
      color = max(color, heightManifoldColor * heightManifoldAlpha);`)}return t.pointDistanceEnabled&&(n.uniforms.add(new S("angleCutoff",i=>M(i)),new E("pointDistanceSphere",(i,s)=>Ke(i,s))),n.main.add(r`float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
