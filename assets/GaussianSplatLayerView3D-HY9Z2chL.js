...
}`),i.uniforms.add(new Ee("tileCameraPosition",e=>e.tileCameraPosition),new Ee("cameraDelta",e=>e.cameraDelta)).code.add(_`vec3 unpackCameraRelativeGaussianPosition(uvec4 packedHeader, highp vec3 position) {
...
depth /= 16777215.0;
return depth;
}`)}class j extends Ye{constructor(e){super(),this.spherical=e,this.alphaCutoff=1,this.fadingEnabled=!1,this.terrainDepthTest=!1,this.cullAboveTerrain=!1,this.occlusionPass=!1,this.receiveAmbientOcclusion=!1,this.pbrMode=0,this.useCustomDTRExponentForWater=!1,this.useFillLights=!1,this.hasColorTexture=!0}}function Si(i){switch(i){case 2:return .005;case 0:return .05;default:return .01}}m([N({count:3})],j.prototype,"alphaCutoff",void 0),m([N()],j.prototype,"fadingEnabled",void 0),m([N()],j.prototype,"terrainDepthTest",void 0),m([N()],j.prototype,"cullAboveTerrain",void 0),m([N()],j.prototype,"receiveAmbientOcclusion",void 0);class Me extends Ti{constructor(){super(...arguments),this.focalLength=-1,this.minSplatRadius=-1,this.tanFov=Je()}}function rt(i){const e=new Pe;e.varyings.add("vColor","vec4"),e.varyings.add("conicOpacity","vec4"),e.varyings.add("offsetFromCenter","vec2"),e.vertex.uniforms.add(new fe("splatOrderTexture",s=>s.splatOrder),new fe("splatFadingTexture",s=>s.splatFading),new fe("splatAtlasTexture",s=>s.splatAtlas),new Ie("focalLength",s=>s.focalLength),new Ie("minSplatRadius",s=>s.minSplatRadius),new zt("tanFov",s=>s.tanFov),new Oe("screenSize",({camera:s})=>Ke(Di,s.fullWidth,s.fullHeight)),new Re("proj",s=>s.camera.projectionMatrix),new Re("view",s=>s.camera.viewMatrix),new Oe("nearFar",s=>s.camera.nearFar),new $t("cameraPosition",s=>s.camera.eye)),e.vertex.include(Ci),e.vertex.include(Pi),e.vertex.include(wi),e.vertex.include(Mt,i),e.include(Ft,i),Gt(e.vertex),Et(e.vertex),e.include(It,i),e.outputs.add("fragColor","vec4",0),e.outputs.add("fragDepthColor","vec4",1);const t=Si(i.alphaCutoff),a=Math.log(t),n=-2*a;return e.vertex.code.add(_`vec2 ndcToPixel(vec2 ndcCoord, vec2 screenSize) {
return ((ndcCoord + 1.0) * screenSize - 1.0) * 0.5;
  ...
  `),e}const Di=Je(),Ai=Object.freeze(Object.defineProperty({__proto__:null,GaussianSplatPassParameters:Me,build:rt},Symbol.toStringTag,{value:"Module"}));let Fe=class extends Ce{};function ot(i){const e=new Pe;e.include(et);const{hasEmission:t}=i,a=e.fragment;return t&&a.include(Rt),a.uniforms.add(new ae("colorTexture",n=>n.color),new ae("splatOutputColor",n=>n.splatColor)),t&&a.uniforms.add(new ae("emissionTexture",n=>n.emission)),e.outputs.add("fragColor","vec4",0),t&&e.outputs.add("fragEmission","vec4",1),e.fragment.main.add(_`
