import{kb as be,my as we,pP as De,EJ as f,pG as w,pM as Ve,pw as B,Iv as r,sl as j,Go as ee,BM as xe,pD as L,lp as te,iy as A,jf as H,pQ as ye,C8 as ie,EP as ne,pB as S,gp as _,AI as v,Nv as se,zZ as ae,yQ as o,JD as re,hg as Ee,F as Le,fe as Se,os as le,z1 as oe,KO as Ce,IB as Me,ug as Ae,Iy as $e,pH as Re,Ag as F,oo as Te,nw as ce,HW as he,iY as de,ly as Oe,DD as G,KV as z,iV as c,lf as q,Hu as pe,fG as ue,or as Ie,Jh as I,iE as Ue,EM as ze,DV as je,kc as qe,uD as V,JK as Ne,gV as k,GP as We,DY as Be,CZ as $,BO as He,b0 as J,y3 as Fe,L1 as Ge,eY as ke,Cr as Je,kO as Ke,u1 as Qe,j1 as C,l1 as Ye,Ha as K}from"./index-CcQ1xweR.js";import{t as Ze}from"./VisualElement-DU91MK12.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new B("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
vec4 color = vec4(0.0);`),t.heightManifoldEnabled){n.uniforms.add(new S("angleCutoff",s=>M(s)),new L("heightPlane",(s,a)=>me(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,u),a.camera.viewMatrix)));const i=t.spherical?r`normalize(globalOrigin - pos)`:r`heightPlane.xyz`;n.main.add(r`
      ...
      color = max(color, heightManifoldColor * heightManifoldAlpha);`)}return t.pointDistanceEnabled&&(n.uniforms.add(new S("angleCutoff",i=>M(i)),new L("pointDistanceSphere",(i,s)=>Xe(i,s))),n.main.add(r`float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
