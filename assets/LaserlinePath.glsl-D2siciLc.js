import{kb as be,mx as we,pP as De,EL as f,pG as w,pM as Ve,pw as F,Ix as r,sm as z,Gq as ee,BP as xe,pD as y,lo as te,iy as A,jf as B,pQ as Ee,Cc as ie,ER as ne,pB as S,gp as _,AL as v,Nx as se,z_ as ae,yS as o,JF as re,hg as Le,F as ye,fd as Se,os as le,z3 as oe,KQ as Ce,ID as Me,uh as Ae,IA as $e,pH as Re,Ah as H,oo as Te,nv as ce,HY as he,iY as de,lx as Oe,DF as G,KX as j,iV as c,le as q,Hw as pe,fF as ue,or as Ie,Jj as I,iE as Ue,EO as je,DX as ze,kc as qe,uE as V,JM as Ne,gV as k,GR as We,D_ as Fe,D1 as $,BR as Be,b0 as X,y4 as He,L3 as Ge,eX as ke,Cv as Xe,kN as Je,u2 as Qe,j1 as C,l0 as Ke,Hc as J}from"./index-Dm62bax_.js";import{t as Ye}from"./VisualElement-6vx8zH1n.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new F("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
